...
Dins de l'editor, afegim dues línies per programar els backups:

![Primera versió del crontab amb les tasques de backup](/tasca02/img_t02_lin/captura27.png)

La configuració inicial inclou només la tasca del backup complet els diumenges.
